# 強さとは、優しさのことだった ──「ネオシャーマニズム講座 vol.7」を解いてみる
...
強さは、怒りの大きさではない。**何を、誰を、守ろうとしているかの深さ**だ。
...
朝陽が言う「祈りの力」は、この延長線上にある。**天に繋がって、神と通じる力** ── 抽象的に聞こえるが、身体のレベルで言えば、**自分という個体の筋力を超えて、もっと大きな系（地面・重力・天）と一体化して力を引き出す状態**のことだ。
...
自己啓発に疲れた人が、最後にスピリチュアルに行き着くのは、弱さではない。**マズローが予言した、人間の欲求の自然な到達点**だ。
...
人間が「通り道」になった時、そこを通る力は、もう個人のパワーではない。**天と地を貫く、フォース**だ。
