...
description: "サナンガとは何か アマゾンの伝統的な目薬を文化として読む。サナンガとはを、シャーマニズムの思想、光さんの一次情報、安全確認の観点から静かに整理する。"
category: "practice"
tags:
  - "サナンガ"
  - "メディスン"
...
## サナンガとは何か アマゾンの伝統的な目薬を文化として読む

サナンガとはという言葉を、ここでは単なる用語としてではなく、シャーマニズムの実践へ入る前に読むための地図として扱う。
