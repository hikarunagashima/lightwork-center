...
description: "サナンガとハペ なぜ入口のセレモニーで組み合わされるのか。サナンガ ハペを、シャーマニズムの思想、光さんの一次情報、安全確認の観点から静かに整理する。"
category: "practice"
tags:
  - "サナンガ"
  - "ハペ"
...
## サナンガとハペ なぜ入口のセレモニーで組み合わされるのか

サナンガ ハペという言葉を、ここでは単なる用語としてではなく、シャーマニズムの実践へ入る前に読むための地図として扱う。
