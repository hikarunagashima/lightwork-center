...
description: "ハペと瞑想 祈りの焦点をどう扱うか。ハペ 瞑想を、シャーマニズムの思想、光さんの一次情報、安全確認の観点から静かに整理する。"
category: "practice"
tags:
  - "ハペ"
  - "瞑想"
...
ハペ 瞑想という言葉を、ここでは単なる用語としてではなく、シャーマニズムの実践へ入る前に読むための地図として扱う。
