...
description: "メディスンホイールの入口としてのハペ。ハペ メディスンホイールを、シャーマニズムの思想、光さんの一次情報、安全確認の観点から静かに整理する。"
...
ハペ メディスンホイールという言葉を、ここでは単なる用語としてではなく、シャーマニズムの実践へ入る前に読むための地図として扱う。
...
- 導入: なぜ今このテーマを読むのか
- ハペ メディスンホイールの定義: 言葉を短く、断定しすぎず説明する
