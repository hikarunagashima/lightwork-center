...
description: "サナンガと瞑想 目を通して祈りの入口を開くという考え方。サナンガ 瞑想を、シャーマニズムの思想、光さんの一次情報、安全確認の観点から静かに整理する。"
category: "practice"
tags:
  - "サナンガ"
  - "瞑想"
...
## サナンガと瞑想 目を通して祈りの入口を開くという考え方

サナンガ 瞑想という言葉を、ここでは単なる用語としてではなく、シャーマニズムの実践へ入る前に読むための地図として扱う。
