...
const TESTIMONIALS: ReadonlyArray<Testimonial> = [
  {
    ...
    paragraphs: [
      ...
      [
        ...
        "アダムカドモン覚醒 イニシエーションパックでは、そうしたトラウマが脳に残した物理的な痕跡を修復できると聞いた。自分でもClaudeに聞いたり、海外の論文を読み漁った。調べていくと、ヘロイン中毒の治療にも使われていることがわかった。海外でそういう状況の人を実際に見たことがあったから、これが持っているポジティブな力の大きさは感覚的に理解できた。",
