...
export const metadata: Metadata = {
  title: "Voices",
  description:
    "セレモニーを受けた方々の声。フルリペアプログラム、その他のメディスン体験のご感想を、ご本人の許可のもと匿名で掲載しています。",
};
...
const TESTIMONIALS: ReadonlyArray<Testimonial> = [
  {
    ...
    program: "Full Repair Programme",
    title: "フルリペアプログラム 体験レビュー",
    paragraphs: [
      [
        ...
        "自分の限界値そのものを上げたい ── そう相談したことがきっかけで、非常に短いスパンでイボガのフルリペアプログラムを受けることになった。",
      ],
      [
        ...
        "フルリペアプログラムでは、そうしたトラウマが脳に残した物理的な痕跡を修復できると聞いた。自分でもClaudeに聞いたり、海外の論文を読み漁った。調べていくと、ヘロイン中毒の治療にも使われていることがわかった。海外でそういう状況の人を実際に見たことがあったから、これが持っているポジティブな力の大きさは感覚的に理解できた。",
