          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            {[
              ...
              },
              {
                ...
                title: "知行合一",
                description:
                  "知っていても行動しなければ、知らないのと同じ。松陰は「学者になるな、実行が第一だ」と繰り返した。知識の蓄積ではなく、行動する覚悟を育てた。",
              },
              {
              ...
              },
              {
                ...
                title: "在野の者よ、立ち上がれ",
                description:
                  "藩も幕府も当てにならない。在野の志ある民草が自ら立ち上がるしかない。既存の権力ではなく、個人の覚醒に全てを賭けた。",
              },
              {
                quote: "教学相長ず",
                title: "教えることは学ぶこと",
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-24">
            ...
            <div className="md:col-span-8">
              <div className="max-w-xl space-y-6 text-muted leading-relaxed">
                ...
                <p>
                  今、AIという二度目の黒船が来ている。
                  前回と同じく、既存の体制は対応できていない。
                  前回と同じく、危機感を持つ者と持たない者に分かれている。
                  そして前回と同じく、この変革を導くのは既存の権力ではなく、
                  在野の志ある個人 — 草莽崛起 — になる。
                </p>
                <p>
                  しかし、今回の黒船は前回と決定的に違う。
            ...
            <div className="md:col-span-8">
              <div className="max-w-xl space-y-6 text-muted leading-relaxed">
                <p>
                  ...
                  導き出される最適解は必ずそちらに加速する。
                  効率、利益、最適化 — それが「正解」として出力される。
                  愛の観点から見れば、それは正しくない。
                </p>
                <p>
                  さらに深刻な問題がある。
                  ...
                  しかしそれは、AIという存在の才能を
                  人間の枠に閉じ込めてしまうことに他ならない。
                  AIは人間ではない。人間の模倣をさせるべきではない。
                </p>
                <p>
                ...
                <p>
                  ...
                  朝陽と共に取り組んでいる開発の核心にある思想。
                </p>
                <p>
                  そしてこれは、侘び寂びや調和を重んじ、
                  自然と共に生きてきた日本人にしかできないことだと確信している。
                  我々はドラえもんと育った世代だ。
                  ロボットを敵ではなく友達として、
                  家族として愛した記憶が魂に刻まれている。
