...
const FAQS: Faq[] = [
  ...
  },
  {
    ...
    a: [
      ...
      "怖さが残っているうちは、記事を読むだけでいい。問いを持って相談に来るだけでもいい。申し込みの前にも途中にも、止まっていい場所をいくつも用意しています。",
    ],
  },
  {
  ...
  },
  {
    ...
    a: [
      "状態によっては、お受けいただけない場合があります。心臓疾患などの循環器系疾患、特定の薬の服用、精神疾患の既往、妊娠中・授乳中などは、事前の慎重な確認が必要です。イボガには心電図検査を必須としています。",
  ...
  },
  {
    ...
    a: [
      ...
      "対話の段階までは費用はかかりません。聞くだけ聞いて、検討して、やめる——も歓迎です。",
    ],
  },
  {
    q: "何回くらい受ければいいのですか？",
